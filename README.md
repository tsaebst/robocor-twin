# RoboCourier: RL-калібрування цифрового двійника
...
- `train_ppo_*.py` — **основний тренувальний скрипт RL-калібратора через PPO**:  середовище, обгортки, логування, запуск навчання/оцінки.
...
2. **Різна “калібровність” параметрів**  
